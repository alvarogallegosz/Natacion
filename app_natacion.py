...
t_pb = st.sidebar.number_input("Edad del PB Actual (t_pb):", min_value=t0, max_value=30.0, value=11.0, step=0.01)
...
T_pb = st.sidebar.number_input("Tiempo del PB Actual (T_pb en segundos):", min_value=1.0, value=70.0, step=0.01)
T_target = st.sidebar.number_input("Tiempo Objetivo Peak (T_target en segundos):", min_value=1.0, value=54.0, step=0.01)
