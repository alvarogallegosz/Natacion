...
st.set_page_config(
    ...
    page_title="Swimming Club Projections, Schedules and Reports",
...
if "genero_usuario" not in st.session_state:

    st.session_state.genero_usuario = ""

if "fecha_nacimiento_usuario" not in st.session_state:

    st.session_state.fecha_nacimiento_usuario = None
