...
if not st.session_state.autenticado:
    st.markdown("<h2 style='text-align: center;'>🔐 Acceso al Sistema de Proyección de Rendimiento Deportivo del Club de Natación Centro Gallego</h2>", unsafe_allow_html=True)
