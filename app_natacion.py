...
# -------------------------------------------------------------
    # PESTAÑA: REPORTES Y RENDIMIENTO HISTÓRICO (RECONFIGURADA - ESTABLE)
    # -------------------------------------------------------------
    with tab_reportes:
        if st.session_state.rol in ["Head Coach", "Entrenador", "Administrador"]:        
            ...
            # Recuperar cliente seguro usando tu método nativo del archivo original
            supabase = st.session_state.get("supabase_client")
            
            if not supabase:
                st.error("🔌 Conexión a base de datos no encontrada de forma segura en la sesión.")
            else:
                with col_rep1:
                    try:
                ...
                # =============================================================================
                # CORRECCIÓN AQUÍ: Se utiliza la variable segura 'supabase' en lugar de la llamada directa que rompía la app
                        ...
                        try:
                            ...
                            if not res_bit.data:
                                ...
                                if df_cargas.empty:
                                    ...
                                    # Renderizar gráfico de forma directa con tus configuraciones de Matplotlib fijadas en el archivo
                                    ...
                                    # =============================================================================
                                    # ACTIVACIÓN DE BOTÓN DE IMPRESIÓN VÍA JAVASCRIPT INYECTADO
                                    # =============================================================================
                                    st.markdown(f"""
                                    ...
                                    # Matriz diaria de auditoría visual
                                    ...
                                    # Generación limpia de los datos crudos para las descargas (antes de añadir fila de total)
                                    ...
                                    # Fila de TOTAL ACUMULADO exclusiva para la vista de pantalla HTML
                                    fila_tot_ban = {
                                    ...
                                    # =============================================================================
                                    # RETORNO COSMÉTICO DE BOTONES DE DESCARGA NATIVOS ABAJO
                                    # =============================================================================
