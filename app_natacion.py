...
if modo_equipo:
    ...
    todos_los_tiempos_ind = [T0, T_pb, T_target]
        ...
        # =========================================================================
        # PROCESAMIENTO SEGURO DE HITOS (RECOLECCIÓN PARA GRÁFICO Y TABLA)
        # =========================================================================
        datos_tabla_micro = []
        ...
        if es_modo_micro_tabla:
            if datos_tabla_micro:
                ...
                df_table_render = pd.DataFrame([{
                    "Competencia / Evento": "Sin hitos o competencias en este rango de edad",
                    "Fecha": "-",
                    "Edad": "-",
                    "Tiempo Prog.": "-"
                }])
        ...
        # -------------------------------------------------------------
        # 6. DESPLIEGUE FINAL EN STREAMLIT
        # -------------------------------------------------------------
