...
# =====================================================================
# INICIO DE MÓDULOS POR PESTAÑAS (NUEVO CÓDIGO INTEGRADO)
# =====================================================================
if st.session_state.rol in ["Entrenador", "Administrador"]:
    tab_analisis, tab_pizarra = st.tabs(["📈 Análisis de Rendimiento", "📝 Pizarra de Entrenamiento Diario"])
else:
    # Si es solo nadador, forzamos un tab único transparente para mantener la compatibilidad estructural
...
if st.session_state.rol in ["Entrenador", "Administrador"]:
    ...
    # ---------------------------------------------------------------------
# PESTAÑA 1: ANÁLISIS DE RENDIMIENTO (CÓDIGO ORIGINAL INDENTADO)
# ---------------------------------------------------------------------
with tab_analisis:
    ...
    # -------------------------------------------------------------------------
    # ST.MARKDOWN - CENTRO DE EXPORTACIÓN (TAMBIÉN INDENTADO)
    # -------------------------------------------------------------------------
    st.markdown("---")
